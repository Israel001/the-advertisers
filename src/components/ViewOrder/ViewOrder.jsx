                ...
                <form>
                  {/* <div className="sm:flex sm:space-x-5 items-center mb-6">
                    <div className="sm:w-1/2  mb-5 sm:mb-0">
                      ...
                      <div className="w-full h-[50px] appearance-none block w-full bg-gray-200 text-gray-500 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none mb-2"></div>
                    </div>
                ...
                <div className="w-full mt-[30px]">
                  <div className="flex justify-between sub-total mb-6">
                    <span className="text-[15px] font-medium text-qblack mb-[18px] block">
                      Shipping ({`${orderObject?.shipping?.type}`})
                    </span>
