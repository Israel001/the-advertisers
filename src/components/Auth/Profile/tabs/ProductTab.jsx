      ...
      <div className="relative w-full overflow-x-auto sm:rounded-lg">
        {filteredProducts?.length === 0 ? (
          <div className="flex justify-center items-center flex-col gap-4">
            ...
            <p>
              No products, yet! Click on the button below to create a new
              product!
            </p>
            <button
              onClick={handleOpen}
              className="flex items-center rounded justify-center gap-3 bg-red-700 h-[60px] w-[180px] sm:w-[250px] duration-500 text-white text-[16px]"
            >
