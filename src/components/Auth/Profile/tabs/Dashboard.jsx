...
export default function Dashboard() {
  ...
  return (
    <>
      <div className="welcome-msg w-full">
        <div>
          <p className="text-qblack text-lg">
            Hello, {profile?.fullName || profile?.name}
          </p>
      ...
      <div className="dashboard-info mt-8 justify-between items-center bg-primarygray px-7 py-7 w-full">
        <div>
          <div
            style={{
              display: "flex",
          ...
          <div className="mt-5">
            <span className="text-base text-qgraytwo">Email:</span>{" "}
            <span className="text-base text-qblack font-medium">
              {profile?.email}
            </span>
          </div>
          <div className="mt-5">
            <span className="text-base text-qgraytwo">Phone:</span>{" "}
            <span className="text-base text-qblack font-medium">
              +{profile?.phone}
            </span>
          </div>
